...
repo --name=unified-standard --baseurl=http://download.tizen.org/releases/milestone/tizen/unified/tizen-unified_20181024.1/repos/standard/packages/ --ssl_verify=no --priority=99
repo --name=base-standard --baseurl=http://download.tizen.org/releases/milestone/tizen/base/latest/repos/standard/packages/ --ssl_verify=no --priority=99

# Add here your local repo
# repo --name=local --baseurl=file:///{Your_Local_Repo_Path}/ --priority=1
